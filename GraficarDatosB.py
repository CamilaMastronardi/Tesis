...
ax3.grid()
plt.savefig(f'/home/camila/Escritorio/Camila/PrimerosGraficosB/B_{DD}_{MM}_{YYYY}')
...
ax2.set_ylabel('|B| [N]')
ax2.grid()
plt.savefig(f'/home/camila/Escritorio/Camila/PrimerosGraficosB/Bvector_{DD}_{MM}_{YYYY}')